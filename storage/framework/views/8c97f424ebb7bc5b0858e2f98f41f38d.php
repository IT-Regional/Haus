<div class="row timer_div">
    <div class="col-auto">
        <h5 class="h5"><?php echo e($task->title); ?></h5>
    </div>
    <div class="col text-end start-div">
        <?php if($task->time_tracking == 0): ?>
            <a href="#" class="start-task start_timer" data-type="start" data-id="<?php echo e($task->id); ?>">
                <i class="far fa-clock"></i>
                <?php echo e(__('Start Tracking')); ?>

            </a>
        <?php else: ?>
            <div class="timer-counter"></div>
            <a href="#" class="stop-task finish_timer" data-type="stop" data-id="<?php echo e($task->id); ?>">
                <i class="far fa-clock"></i>
                <?php echo e(__('Stop Tracking')); ?>
...
<div class="py-3 my-2 border-top border-bottom">
    <h6 class="text-sm"><?php echo e(__('Description')); ?>:
        <?php if($task->priority == 'low'): ?>
            <div class="badge badge-pill badge-sm badge-success float-right"> <?php echo e(ucfirst($task->priority)); ?></div>
        <?php elseif($task->priority == 'medium'): ?>
            <div class="badge badge-pill badge-sm badge-warning float-right"> <?php echo e(ucfirst($task->priority)); ?></div>
        <?php elseif($task->priority == 'high'): ?>
            <div class="badge badge-pill badge-sm badge-danger float-right"> <?php echo e(ucfirst($task->priority)); ?></div>
        <?php endif; ?>
    </h6>
    <p class="text-sm mb-0"><?php echo e($task->description); ?></p>
</div>

<dl class="row">
    <dt class="col-sm-3"><span class="h6 text-sm mb-0"><?php echo e(__('Start Date')); ?></span></dt>
    <dd class="col-sm-9"><span class="text-sm"><?php echo e(\Auth::user()->dateFormat($task->start_date)); ?></span>
    </dd>
    <dt class="col-sm-3"><span class="h6 text-sm mb-0"><?php echo e(__('Due Date')); ?></span></dt>
    <dd class="col-sm-9"><span class="text-sm"><?php echo e(\Auth::user()->dateFormat($task->due_date)); ?></span>
    </dd>
    <dt class="col-sm-3"><span class="h6 text-sm mb-0"><?php echo e(__('Milestone')); ?></span></dt>
    <dd class="col-sm-9"><span class="text-sm"><?php echo e(!empty($task->milestone) ? $task->milestone->title : ''); ?></span>
    </dd>
</dl>
            ...
            <div class="card-body">
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-user-1" role="tabpanel"
                        ...
                        <h3 class="mb-0"><?php echo e(__('Checklist')); ?></h3>
                        <div class="row mt-3">
                            <div class="col-md-11">
                                <div class="row">
                            ...
                            <form method="POST" id="form-checklist" class="collapse col-md-12"
                                data-action="<?php echo e(route('project.task.checklist.store', [$task->id])); ?>">
                                <input type="hidden" name="_token" id="token" value="<?php echo e(csrf_token()); ?>">
                                <div class="form-group">
                                    <label class="form-label text-start"><?php echo e(__('Name')); ?></label>
                                    <input type="text" name="name" class="form-control" required
                                        placeholder="<?php echo e(__('Checklist Name')); ?>">
                                </div>
                                <div class="text-end">
                                                ...
                                                <div class="px-3 py-2 row align-items-center">
                                                    <div class="col-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox"
                                                                id="checklist-<?php echo e($checkList->id); ?>"
                                                                class="custom-control-input taskCheck"
                                                                <?php echo e($checkList->status == 1 ? 'checked' : ''); ?>

                                                                value="<?php echo e($checkList->id); ?>"
                                                                data-url="<?php echo e(route('project.task.checklist.update', [$checkList->task_id, $checkList->id])); ?>">
                                                            <label class="custom-control-label h6 text-sm"
                                                                for="checklist-<?php echo e($checkList->id); ?>"><?php echo e($checkList->name); ?></label>
                                                        </div>
                                                    </div>
                                                    <div class="action-btn bg-danger ms-2">
                                                        <a href="#"class="mx-3 btn btn-sm d-inline-flex align-items-center delete-checklist"
                                                            data-url="<?php echo e(route('project.task.checklist.destroy', [$checkList->task_id, $checkList->id])); ?>">
                    ...
                    <div class="tab-pane fade" id="pills-user-2" role="tabpanel" aria-labelledby="pills-user-tab-2">
                        <h3 class="mb-0"><?php echo e(__('Comment')); ?></h3>
                                ...
                                <?php $__currentLoopData = $task->comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="list-group-item comment-div">
                                        <div class="row">
                                            <div class="col ml-n2">
                                                <a href="#!"
                                                    class="d-block h6 mb-0"><?php echo e(!empty($comment->user) ? $comment->user->name : ''); ?></a>
                                                <div>
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                <a href="#"
                                                    ...
                                                    data-url="<?php echo e(route('project.task.comment.destroy', [$comment->id])); ?>">
                                                    <i class="ti ti-trash text-white"></i>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <li class="col-12 border-0 ">
                            <form id="form-comment" data-action="<?php echo e(route('project.task.comment.store', [$task->project_id, $task->id])); ?>">
                            ...
                            <?php if(App\Models\Utility::is_chatgpt_enable()): ?>
                                <div class="col-12 text-end">
                                    <a data-size="md" class="btn btn-primary btn-icon btn-sm text-white "
                                        ...
                                        data-url="<?php echo e(route('grammar', ['task_show'])); ?>" data-bs-placement="top"
                    ...
                    <div class="tab-pane fade" id="pills-user-3" role="tabpanel" aria-labelledby="pills-user-tab-3">
                        <h3 class="mb-0"><?php echo e(__('Files')); ?></h3>
                        <div class="row mt-3">
                            <form method="post" id="form-file" enctype="multipart/form-data"
                                data-url="<?php echo e(route('project.task.comment.file.store', $task->id)); ?>">
                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="px-3 py-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="action-btn bg-info ms-2">
                                                        <a download href="<?php echo e($file_storage . $file->file); ?>"
                                                    ...
                                                    <div class="action-btn bg-danger ms-2">
                                                        <a href="#"
                                                            ...
                                                            data-url="<?php echo e(route('project.task.comment.file.destroy', [$file->id])); ?>">
                                                            <i class="ti ti-trash text-white"></i>
                                                        </a>
                                                    </div>
                                                </div>
                    ...
                    <div class="tab-pane fade" id="pills-user-4" role="tabpanel" aria-labelledby="pills-user-tab-4">
                        <h3 class="mb-0"><?php echo e(__('Time Tracking')); ?></h3>
                        <div class="row mt-3">
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header card-body table-border-style" id="comments">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="pc-dt-simple">
                                                ...
                                                <tbody>
                                                    <?php $__currentLoopData = $task->taskTimer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr>
                                                            <td><?php echo e($time->start_time); ?></td>
                                                            <td><?php echo e($time->end_time); ?></td>
                                                            <td><?php echo e($task->taskTime($time->start_time, $time->end_time)); ?>

                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td colspan="2" class="text-right"><?php echo e(__('Total Time')); ?>

                                                            :</td>
                                                        <td><?php echo e($task->totalTime()); ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
...
<script>
    ...
    $(document).on('click', '#form-comment', function(e) {
        ...
        if (comment != '') {
            ...
            toastrs('Success', '<?php echo e(__('Write Your Comment About This Task.')); ?>', 'success');
    ...
    $(document).on('submit', '#form-file', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                toastrs('Success', '<?php echo e(__('Files successfully uploaded.')); ?>', 'success');
                ...
                var html = '<div class="card mb-3 border shadow-none">\n' +
                    ...
                    '                                        <a downloaced href="<?php echo e(asset(Storage::url('tasks'))); ?>' +
                    data.file +
            ...
            error: function(data) {
                ...
                if (data.message) {
                    ...
                    toastrs('<?php echo e(__('Error')); ?>', 'The attachment must be a file of type',
                        'error');
                } else {
                    toastrs('Error', '<?php echo e(__('Some Thing Is Wrong!')); ?>', 'error');
                }
            ...
            success: function(data) {
                ...
                if (data.status == 'success') {
                    main_div.find('.start-div').html(
                        ...
                        id + '"><i class="far fa-clock"></i> <?php echo e(__('Stop Tracking')); ?></a>');
            ...
            success: function(data) {
                ...
                if (data.status == 'success') {
                    main_div.find('.start-div').html(
                        ...
                        id + '"><i class="far fa-clock"></i> <?php echo e(__('Start Tracking')); ?> </a>');
...
<?php /**PATH C:\xampp\htdocs\main-file\resources\views/project/taskShow.blade.php ENDPATH**/ ?>