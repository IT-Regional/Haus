<?php
    ...
    $company_favicon = $adminSettings['favicon'];

    $fav = \App\Models\Utility::get_file('uploads/logo/');
    $meta_image = \App\Models\Utility::get_file('uploads/meta/');

    // $getseo = App\Models\Utility::getSeoSetting();
    $metatitle = !empty($adminSettings['meta_title']) ? $adminSettings['meta_title'] : '';
    $metsdesc = !empty($adminSettings['meta_desc']) ? $adminSettings['meta_desc'] : '';
    $meta_logo = !empty($adminSettings['meta_image']) ? $adminSettings['meta_image'] : '';
    // $get_cookie = Utility::getCookieSetting();

    $SITE_RTL = !empty($adminSettings['SITE_RTL']) ? $adminSettings['SITE_RTL'] : '';
...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon"
        href="<?php echo e($fav . '/' . (isset($company_favicon) && !empty($company_favicon) ? $company_favicon : 'favicon.png') . '?timestamp=' . time()); ?>"type="image/x-icon" />
    ...
    <?php if(!empty($adminSettings['cust_darklayout']) && $adminSettings['cust_darklayout'] == 'on'): ?>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link active"
                                href="<?php echo e(url('/')); ?>#home"><?php echo e($settings['home_title']); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                ...
                <div class="col-xxl-4 col-md-6">
                    ...
                    <div class="d-flex gap-3 mt-4 banner-btn">
                        <?php if($settings['home_live_demo_link']): ?>
                            <a href="<?php echo e($settings['home_live_demo_link']); ?>" class="btn btn-outline-dark"><?php echo e(__('Live Demo')); ?>
            ...
            <div class="row g-0 gy-2 mt-4 align-items-center">
                ...
                <div class="col-xxl-9">
                    <div class="row gy-3 row-cols-9">
                        <?php if(explode(',', $settings['home_logo']) ): ?>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                ...
                <?php if($settings['discover_buy_now_link']): ?>
                    <a href="<?php echo e($settings['discover_buy_now_link']); ?>" class="btn btn-primary rounded-pill"><?php echo e(__('Buy Now')); ?>
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price"><?php echo e(\App\Models\Utility::getValByName('currency_symbol') . $value->price); ?><small
                                ...
                                <ul class="list-unstyled my-3">
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-label" for="customCheckc1"><?php echo e($value->max_employee); ?>

                                                <?php echo e(__('Employee')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            
                                            <label class="form-label" for="customCheckc1"><?php echo e($value->max_client); ?>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-label"
                                                for="customCheckc1"><?php echo e($value->storage_limit); ?><?php echo e(__('MB Storage')); ?></label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            ...
                                            <label class="form-label"
                                                ...
                                                <?php echo e(__('Chat GPT')); ?></label>
                                        </div>
                                    </li>
                                </ul>
                                <div class="d-grid">
                                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary rounded-pill"><?php echo e(__('Start with
                                ...
                                <div class="col-xxl-4 col-sm-6 col-lg-6 col-md-4">
                                    <div class="card bg-dark shadow-none mb-0">
                                        <div class="card-body p-3">
                                            ...
                                            <?php echo stripslashes($value->testimonials_description); ?>

                                            </p>
                                            <div class="d-flex  align-items-center ">
                                                <img src="<?php if(isset($value->testimonials_user_avtar)): ?> <?php echo e($logo.'/'. $value->testimonials_user_avtar); ?> <?php else: ?> <?php echo e(url('storage/avatars/avatar.png')); ?> <?php endif; ?> "
...
<footer class="site-footer bg-gray-100">
    ...
    <div class="border-top border-dark text-center p-2">
        ...
        <p class="mb-0"> <?php echo e(__('')); ?> &copy;
...
<?php if(!empty($adminSettings['enable_cookie']) && $adminSettings['enable_cookie'] == 'on'): ?>
    <?php echo $__env->make('layouts.cookie_consent', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
</body>

</html>
<?php /**PATH C:\xampp\htdocs\main-file\main-file\main-file\Modules/LandingPage\Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>