...
<?php
$profile=\App\Models\Utility::get_file(config('chatify.attachments.folder'));    
?>
...
<?php if($viewType == 'sender'): ?>
    ...
    <div>
        <div class="message-card mc-sender">
            <div class="image-file chat-image" style="width: 250px; height: 150px;background-image: url('<?php echo e(\App\Models\Utility::get_file('public/'.config('chatify.attachments.folder').'/'.$attachment[0])); ?>')">
            </div>
        </div>
    </div>
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\main-file\resources\views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>