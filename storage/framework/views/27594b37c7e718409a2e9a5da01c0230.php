    ...
    <?php echo e(Form::open(array('route' => array('item.import'),'method'=>'post', 'enctype' => "multipart/form-data"))); ?>
    ...
    <div class="col-md-12 mb-2">
        <div class="d-flex align-items-center justify-content-between">
            ...
            <div>
                <a href="<?php echo e(asset(Storage::url('uploads/sample')).'/sample-item.csv'); ?>" class="btn btn-sm btn-primary">
...
<?php /**PATH C:\xampp\htdocs\main-file\resources\views/item/import.blade.php ENDPATH**/ ?>