...
<script src="<?php echo e(asset('public/custom_assets/libs/bootstrap-notify/bootstrap-notify.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/letter.avatar.js')); ?>"></script>
<?php echo $__env->yieldPushContent('pre-purpose-script-page'); ?>
...
<!-- <script src="<?php echo e(asset('public/custom_assets/libs/select2/dist/js/select2.min.js')); ?>"></script> -->
<script>
...
<?php /**PATH C:\xampp\htdocs\main-file\main-file\main-file\resources\views/partials/admin/footer.blade.php ENDPATH**/ ?>